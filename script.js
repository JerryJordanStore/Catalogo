...
const products = [
  ...
  { id: "p09", cat: "Polos", name: "Polo Jordan", price: 29.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/jordan_verde.webp"], sizes: sizes(["S"]) },  { name: "Gris", hex: "#8A8A8A", images: ["assets/products/polos/jordan_gris.webp"], sizes: sizes(["M"]) },  { name: "Gris Oscuro", hex: "#6E6E6E", images: ["assets/products/polos/jordan_gris.webp"], sizes: sizes(["L"]) }] },
