...
const products = [
  ...
  { id: "p09", cat: "Polos", name: "Polo Jordan", price: 29.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/jordan_verde.webp"], sizes: sizes(["S"]) }, { name: "Beige", hex: "#D8C7A1", images: ["assets/products/polos/jordan_beige.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Gris", hex: "#8A8A8A", images: ["assets/products/polos/jordan_gris.webp"], sizes: sizes(["M"]) }, { name: "Blanco", hex: "#ffffff", images: ["assets/products/polos/jordan_blanco.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Negro", hex: "#1a1a1a", images: ["assets/products/polos/jordan_negro.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Marrón", hex: "#5B3A29", images: ["assets/products/polos/jordan_marron.webp"], sizes: sizes(["S", "M", "L"]) }] },
