...
const products = [
  ...
  { id: "p02", cat: "Polos", name: "Polo Goat", price: 29.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Vino", hex: "#6B1E2A", images: ["assets/products/polos/goat_rojo.webp"], sizes: sizes(["S"]) }, { name: "Beige", hex: "#D8C7A1", images: ["assets/products/polos/goat_beige.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/goat_negro.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Plomo", hex: "#6E6E6E", images: ["assets/products/polos/goat_gris.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Arena", hex: "#d3cab7b7", images: ["assets/products/polos/goat_crema.webp"], sizes: sizes(["M"]) }] },
  { id: "p48", cat: "Polos", name: "Crewneck Jordan", price: 50.00, old: null, badge: "new", desc: "Producto peruano 100% franela reactiva.", colors: [{ name: "Plomo", hex: "#6E6E6E", images: ["assets/products/polos/crewneck_jordan_plomo.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/crewneck_jordan_verde.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/crewneck_jordan_negro.webp"], sizes: sizes(["S"]) }, { name: "Melange", hex: "#A8A8A2", images: ["assets/products/polos/crewneck_jordan_melange.webp"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p49", cat: "Polos", name: "Crewneck Jordan2", price: 50.00, old: null, badge: "new", desc: "Producto peruano 100% franela reactiva.", colors: [{ name: "Melange", hex: "#A8A8A2", images: ["assets/products/polos/crewneck_jordan2_melange.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Plomo", hex: "#6E6E6E", images: ["assets/products/polos/crewneck_jordan2_plomo.webp"], sizes: sizes(["S", "M", "L"]) }] },
  ...
  { id: "p52", cat: "Polos", name: "Crewneck Arkad", price: 49.90, old: null, badge: "new", desc: "Hecho de franela.", colors: [{ name: "Plomo", hex: "#3A3A3A", images: ["assets/products/polos/crewneck_arkad.webp"], sizes: sizes(["S", "M"]) }] },
  { id: "p53", cat: "Polos", name: "Crewneck Snoopy", price: 49.90, old: null, badge: "new", desc: "Hecho de french terry.", colors: [{ name: "Beige", hex: "#D8C7A1", images: ["assets/products/polos/crewneck_snoopy_beige.webp"], sizes: sizes(["M"]) }, { name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/crewneck_snoopy_negro.webp"], sizes: sizes(["M"]) }] },
  // ---- POLERAS ----
