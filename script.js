...
const products = [
  ...
  { id: "p61", cat: "Polos", name: "Polo Bad Boys", price: 34.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Crema", hex: "#E8DCC0", images: ["assets/products/polos/badboys_crema.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Beige", hex: "#D8C7A1", images: ["assets/products/polos/badboys_beige.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/badboys_negro.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Blanco", hex: "#F2F2ED", images: ["assets/products/polos/badboys_blanco.webp"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p62", cat: "Polos", name: "Polo M' Club", price: 34.90, old: null, badge: "new", desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Plomo", hex: "#6E6E6E", images: ["assets/products/polos/mclub_plomo.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/mclub_negro.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Blanco", hex: "#F2F2ED", images: ["assets/products/polos/mclub_blanco.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/mclub_verde.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Crema", hex: "#E8DCC0", images: ["assets/products/polos/mclub_crema.webp"], sizes: sizes(["S", "M", "L"]) }] },
