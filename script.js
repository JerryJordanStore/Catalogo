...
const products = [
  // ---- POLOS ----
  { id: "p01", cat: "Polos", name: "Polo Corona Doble", price: 39.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/corona_negro_atr.jpg", "assets/products/polos/corona_negro_del.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Blanco", hex: "#F2F2ED", images: ["assets/products/polos/corona_blanco_del.jpg", "assets/products/polos/corona_blanco_atr.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p02", cat: "Polos", name: "Polo Goat", price: 29.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Vino", hex: "#6B1E2A", images: ["assets/products/polos/goat_rojo.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/goat_negro.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Plomo", hex: "#6E6E6E", images: ["assets/products/polos/goat_gris.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Beige", hex: "#D8C7A1", images: ["assets/products/polos/goat_crema.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p03", cat: "Polos", name: "Polo Millionaires", price: 29.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/milionaires_negro.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/milionaires_verde.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Crema", hex: "#E8DCC0", images: ["assets/products/polos/milionaires_blanco.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Gris", hex: "#8A8A8A", images: ["assets/products/polos/milionaires_gris.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p04", cat: "Polos", name: "Polo Jordan", price: 29.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/jordan_verde.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Gris", hex: "#8A8A8A", images: ["assets/products/polos/jordan_gris.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Plomo", hex: "#6E6E6E", images: ["assets/products/polos/jordan_negro.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p05", cat: "Polos", name: "Polo Jordan2", price: 29.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Crema", hex: "#E8DCC0", images: ["assets/products/polos/jordan2_crema.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Blanco", hex: "#F2F2ED", images: ["assets/products/polos/jordan2_blanco.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/jordan2_negro.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p06", cat: "Polos", name: "Polo Old Money", price: 29.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Marrón", hex: "#5B3A29", images: ["assets/products/polos/oldmoney_marron.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/oldmoney_verde.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Plomo", hex: "#6E6E6E", images: ["assets/products/polos/oldmoney_gris.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p07", cat: "Polos", name: "Polo Holográfico JJ", price: 35.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Negro c/Dorado", hex: "#1A1A1A", images: ["assets/products/polos/holo_negro_dorado.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Negro c/Plateado", hex: "#1A1A1A", images: ["assets/products/polos/holo_negro_plateado.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Gris c/Plateado", hex: "#8A8A8A", images: ["assets/products/polos/holo_gris.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p08", cat: "Polos", name: "Polo Inevitable", price: 25.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Blanco", hex: "#F2F2ED", images: ["assets/products/polos/inevitable_blanco.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Gris", hex: "#8A8A8A", images: ["assets/products/polos/inevitable_gris.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p09", cat: "Polos", name: "Polo Francia", price: 39.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/francia_atr.jpg", "assets/products/polos/francia_del.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p10", cat: "Polos", name: "Polo Inglaterra", price: 39.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Blanco", hex: "#F2F2ED", images: ["assets/products/polos/inglaterra_atr.jpg", "assets/products/polos/inglaterra_del.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p11", cat: "Polos", name: "Polo Noruega", price: 39.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Vino", hex: "#6B1E2A", images: ["assets/products/polos/noruega_atr.jpg", "assets/products/polos/noruega_del.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p12", cat: "Polos", name: "Polo Portugal", price: 39.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/portugal_atr.jpg", "assets/products/polos/portugal_del.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p13", cat: "Polos", name: "Polo Inevitable Doble", price: 25.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Blanco", hex: "#F2F2ED", images: ["assets/products/polos/inevitable2_blanco_atr.jpg", "assets/products/polos/inevitable2_blanco_del.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/inevitable2_negro_atr.jpg", "assets/products/polos/inevitable2_negro_del.jpg"], sizes: sizes(["S", "M", "L"]) }, { name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/inevitable2_verde_atr.jpg", "assets/products/polos/inevitable2_verde_del.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  // ---- POLERAS ----
  { id: "p14", cat: "Poleras", name: "Polera JJB", price: 59.00, old: null, badge: "low", desc: "Producto peruano 100% franela reactiva.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/poleras/jjb_verde.jpg"], sizes: sizes(["M"]) }, { name: "Marrón", hex: "#5B3A29", images: ["assets/products/poleras/jjb_marron.jpg"], sizes: sizes(["M"]) }, { name: "Crema", hex: "#E8DCC0", images: ["assets/products/poleras/jjb_crema.jpg"], sizes: sizes(["S"]) }] },
  { id: "p15", cat: "Poleras", name: "Polera Jordan", price: 59.00, old: null, badge: "low", desc: "Producto peruano 100% franela reactiva.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/poleras/jordan_negro.jpg"], sizes: sizes(["L"]) }, { name: "Marrón", hex: "#5B3A29", images: ["assets/products/poleras/jordan_marron.jpg"], sizes: sizes(["M"]) }] },
  { id: "p16", cat: "Poleras", name: "Polera JJB Jordan", price: 59.00, old: null, badge: "low", desc: "Producto peruano 100% franela reactiva.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/poleras/jjb_jordan.jpg"], sizes: sizes(["S", "L"]) }] },
  { id: "p17", cat: "Poleras", name: "Polera NY", price: 59.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Azul", hex: "#2455A4", images: ["assets/products/poleras/polera_ny.jpg"], sizes: sizes(["M"]) }] },
  { id: "p18", cat: "Poleras", name: "Polera Brooklyn", price: 49.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Crema", hex: "#E8DCC0", images: ["assets/products/poleras/brooklyn.jpg"], sizes: sizes(["M"]) }] },
  { id: "p19", cat: "Poleras", name: "Polera Milano", price: 49.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/poleras/milano.jpg"], sizes: sizes(["M"]) }] },
  // ---- CASACAS ----
  { id: "p20", cat: "Casacas", name: "Casaca Vintage P", price: 99.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/casacas/vintage_p.jpg"], sizes: sizes(["L"]) }] },
  { id: "p21", cat: "Casacas", name: "Casaca Vintage A25", price: 99.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/casacas/vintage25_negro.jpg"], sizes: sizes(["M"]) }] },
  { id: "p22", cat: "Casacas", name: "Casaca Vintage 28", price: 99.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Azul", hex: "#2455A4", images: ["assets/products/casacas/vintage28_azul.jpg"], sizes: sizes(["M"]) }, { name: "Negro", hex: "#1A1A1A", images: ["assets/products/casacas/vintage28_negro.jpg"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p23", cat: "Casacas", name: "Casaca Vintage A17", price: 99.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Vino", hex: "#6B1E2A", images: ["assets/products/casacas/vintage17_rojo.jpg"], sizes: sizes(["L"]) }, { name: "Negro", hex: "#1A1A1A", images: ["assets/products/casacas/vintage17_negro.jpg"], sizes: sizes(["M"]) }] },
  { id: "p24", cat: "Casacas", name: "Casaca Vintage Boston", price: 69.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Azul", hex: "#2455A4", images: ["assets/products/casacas/vintage_boston.jpg"], sizes: sizes(["L"]) }] },
  { id: "p25", cat: "Casacas", name: "Casaca Impermeable", price: 79.00, old: null, badge: "low", desc: "Producto 100% peruano con forro acolchado interno.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/casacas/impermeable_verde.jpg"], sizes: sizes(["M"]) }] },
  { id: "p26", cat: "Casacas", name: "Casaca New York", price: 69.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/casacas/casaca_ny.jpg"], sizes: sizes(["M"]) }] },
  // ---- CHALECOS ----
  { id: "p27", cat: "Chalecos", name: "Chaleco impermeable", price: 59.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/chalecos/chaleco_impermeable_negro.jpg"], sizes: sizes(["L"]) }, { name: "Azul", hex: "#2455A4", images: ["assets/products/chalecos/chaleco_impermeable_azul.jpg"], sizes: sizes(["L"]) }] },
  // ---- ACCESORIOS ----
  { id: "p28", cat: "Accesorios", name: "Reloj Naviforce", price: 99.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/naviforce_normal.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p29", cat: "Accesorios", name: "Reloj Curren", price: 99.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/curren.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p30", cat: "Accesorios", name: "Reloj SKMEI", price: 89.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/skmei_normal.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p31", cat: "Accesorios", name: "Reloj Sanda Analógico", price: 99.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/sanda_verde.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p46", cat: "Accesorios", name: "Reloj Sanda Digital", price: 99.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/accesorios/sanda_digital.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p32", cat: "Accesorios", name: "Reloj Naviforce Digital", price: 89.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/naviforce_negro_digital.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p33", cat: "Accesorios", name: "Reloj Poedagar G", price: 89.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/poedagar_grueso.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p34", cat: "Accesorios", name: "Reloj Poedagar D", price: 89.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/poedagar_delgado.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p35", cat: "Accesorios", name: "Reloj SKMEI Digital", price: 89.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/skmei_digital.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p36", cat: "Accesorios", name: "Reloj Navifoce Verde", price: 89.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/accesorios/naviforce_verde_digital.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p37", cat: "Accesorios", name: "Reloj Naviforce Plus", price: 125.00, old: null, badge: "low", desc: "Producto importado, incluye caja.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/naviforce_plus.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p38", cat: "Accesorios", name: "Reloj Poedagar Plateado", price: 115.00, old: null, badge: "low", desc: "Producto importado, incluye caja.", colors: [{ name: "Plateado", hex: "#B8B8B8", images: ["assets/products/accesorios/poedagar_plateado.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p39", cat: "Accesorios", name: "Gorra New York", price: 35.00, old: null, badge: null, desc: "Producto importado.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/accesorios/gorro_ny_negro.jpg"], sizes: sizes(["Único"]) }, { name: "Beige", hex: "#D8C7A1", images: ["assets/products/accesorios/gorro_ny_beige.jpg"], sizes: sizes(["Único"]) }, { name: "Crema", hex: "#E8DCC0", images: ["assets/products/accesorios/gorro_ny_crema.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p40", cat: "Accesorios", name: "Gorra Conejo", price: 35.00, old: null, badge: null, desc: "Producto importado.", colors: [{ name: "Azul", hex: "#2455A4", images: ["assets/products/accesorios/gorro_conejo.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p41", cat: "Accesorios", name: "Lentes Plateado", price: 39.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Plateado", hex: "#B8B8B8", images: ["assets/products/accesorios/lentes_plateado.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p42", cat: "Accesorios", name: "Lentes Negro", price: 39.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/accesorios/lentes_negro.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p43", cat: "Accesorios", name: "Lentes Verde", price: 35.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/accesorios/lentes_verde.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p44", cat: "Accesorios", name: "Lentes Rojo", price: 25.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Rojo", hex: "#C0272D", images: ["assets/products/accesorios/lentes_rojo.jpg"], sizes: sizes(["Único"]) }] },
  { id: "p45", cat: "Accesorios", name: "Lentes Negro Total", price: 35.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/accesorios/lentes_negro_total.jpg"], sizes: sizes(["Único"]) }] },
];
...
function colorPreview(p, max = 4) {
  ...
  return `
    <div class="mini-colors" title="Colores disponibles">
      ${visible.map((c, idx) => `<button type="button" class="mini-swatch" data-id="${p.id}" data-idx="${idx}" style="background:${c.hex}" title="${c.name}"></button>`).join("")}
      ${extra > 0 ? `<span class="mini-swatch-more" title="${colors.slice(max).map(c => c.name).join(", ")}">+${extra}</span>` : ""}
    </div>
  `;
}
