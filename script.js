...
const products = [
  ...
  { id: "p59", cat: "Poleras", name: "Crewneck Millionaires", price: 50.00, old: null, badge: "new", desc: "Producto peruano 100% franela reactiva.", colors: [{ name: "Plomo", hex: "#6E6E6E", images: ["assets/products/poleras/crewneck_millionaires_plomo.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Melange", hex: "#A8A8A2", images: ["assets/products/poleras/crewneck_millionaires_melange.webp"], sizes: sizes(["S", "M", "L"]) } ] },
  { id: "p60", cat: "Poleras", name: "Crewneck Goat", price: 50.00, old: null, badge: "new", desc: "Producto peruano 100% franela reactiva.", colors: [{ name: "Melange", hex: "#A8A8A2", images: ["assets/products/poleras/crewneck_goat_melange.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Plomo", hex: "#6E6E6E", images: ["assets/products/poleras/crewneck_goat_plomo.webp"], sizes: sizes(["S", "M", "L"]) }] },
