...
const products = [
  ...
  { id: "p26", cat: "Poleras", name: "Polera Brooklyn", price: 49.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Crema", hex: "#E8DCC0", images: ["assets/products/poleras/brooklyn.webp"], sizes: sizes(["M"]) }] },
  { id: "p27", cat: "Poleras", name: "Polera Milano", price: 49.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/poleras/milano.webp"], sizes: sizes(["M"]) }] },
  ...
  { id: "p41", cat: "Casacas", name: "Casaca Vintage Boston", price: 69.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Azul", hex: "#2455A4", images: ["assets/products/casacas/vintage_boston.webp"], sizes: sizes(["L"]) }] },
