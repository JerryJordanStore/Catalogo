...
const products = [
  ...
  { id: "p02", cat: "Polos", name: "Polo Goat", price: 29.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Vino", hex: "#6B1E2A", images: ["assets/products/polos/goat_rojo.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/goat_negro.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Plomo", hex: "#6E6E6E", images: ["assets/products/polos/goat_gris.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Beige", hex: "#D8C7A1", images: ["assets/products/polos/goat_crema.webp"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p03", cat: "Polos", name: "Polo Millionaires", price: 29.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/milionaires_negro.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/milionaires_verde.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Crema", hex: "#E8DCC0", images: ["assets/products/polos/milionaires_blanco.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Gris", hex: "#8A8A8A", images: ["assets/products/polos/milionaires_gris.webp"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p04", cat: "Polos", name: "Polo Jordan", price: 29.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/jordan_verde.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Gris", hex: "#8A8A8A", images: ["assets/products/polos/jordan_gris.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Plomo", hex: "#6E6E6E", images: ["assets/products/polos/jordan_negro.webp"], sizes: sizes(["S", "M", "L"]) }] },
  ...
  { id: "p06", cat: "Polos", name: "Polo Old Money", price: 29.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Marrón", hex: "#5B3A29", images: ["assets/products/polos/oldmoney_marron.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/oldmoney_verde.webp"], sizes: sizes(["S", "M", "L"]) }, { name: "Plomo", hex: "#6E6E6E", images: ["assets/products/polos/oldmoney_gris.webp"], sizes: sizes(["S", "M", "L"]) }] },
  ...
  { id: "p09", cat: "Polos", name: "Polo Francia", price: 39.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/polos/francia_atr.webp", "assets/products/polos/francia_del.webp"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p10", cat: "Polos", name: "Polo Inglaterra", price: 39.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Blanco", hex: "#F2F2ED", images: ["assets/products/polos/inglaterra_atr.webp", "assets/products/polos/inglaterra_del.webp"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p11", cat: "Polos", name: "Polo Noruega", price: 39.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Vino", hex: "#6B1E2A", images: ["assets/products/polos/noruega_atr.webp", "assets/products/polos/noruega_del.webp"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p12", cat: "Polos", name: "Polo Portugal", price: 39.90, old: null, badge: null, desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/portugal_atr.webp", "assets/products/polos/portugal_del.webp"], sizes: sizes(["S", "M", "L"]) }] },
  ...
  // ---- POLERAS ----
  { id: "p14", cat: "Poleras", name: "Polera JJB", price: 59.00, old: null, badge: "low", desc: "Producto peruano 100% franela reactiva.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/poleras/jjb_verde.webp"], sizes: sizes(["M"]) }, { name: "Marrón", hex: "#5B3A29", images: ["assets/products/poleras/jjb_marron.webp"], sizes: sizes(["M"]) }, { name: "Crema", hex: "#E8DCC0", images: ["assets/products/poleras/jjb_crema.webp"], sizes: sizes(["S"]) }] },
  { id: "p15", cat: "Poleras", name: "Polera Jordan", price: 59.00, old: null, badge: "low", desc: "Producto peruano 100% franela reactiva.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/poleras/jordan_negro.webp"], sizes: sizes(["L"]) }, { name: "Marrón", hex: "#5B3A29", images: ["assets/products/poleras/jordan_marron.webp"], sizes: sizes(["M"]) }] },
  { id: "p16", cat: "Poleras", name: "Polera JJB Jordan", price: 59.00, old: null, badge: "low", desc: "Producto peruano 100% franela reactiva.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/poleras/jjb_jordan.webp"], sizes: sizes(["S", "L"]) }] },
  { id: "p17", cat: "Poleras", name: "Polera NY", price: 59.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Azul", hex: "#2455A4", images: ["assets/products/poleras/polera_ny.webp"], sizes: sizes(["M"]) }] },
  { id: "p18", cat: "Poleras", name: "Polera Brooklyn", price: 49.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Crema", hex: "#E8DCC0", images: ["assets/products/poleras/brooklyn.webp"], sizes: sizes(["M"]) }] },
  { id: "p19", cat: "Poleras", name: "Polera Milano", price: 49.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/poleras/milano.webp"], sizes: sizes(["M"]) }] },
  // ---- CASACAS ----
  { id: "p20", cat: "Casacas", name: "Casaca Vintage P", price: 99.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/casacas/vintage_p.webp"], sizes: sizes(["L"]) }] },
  { id: "p21", cat: "Casacas", name: "Casaca Vintage A25", price: 99.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/casacas/vintage25_negro.webp"], sizes: sizes(["M"]) }] },
  { id: "p22", cat: "Casacas", name: "Casaca Vintage 28", price: 99.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Azul", hex: "#2455A4", images: ["assets/products/casacas/vintage28_azul.webp"], sizes: sizes(["M"]) }, { name: "Negro", hex: "#1A1A1A", images: ["assets/products/casacas/vintage28_negro.webp"], sizes: sizes(["S", "M", "L"]) }] },
  { id: "p23", cat: "Casacas", name: "Casaca Vintage A17", price: 99.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Vino", hex: "#6B1E2A", images: ["assets/products/casacas/vintage17_rojo.webp"], sizes: sizes(["L"]) }, { name: "Negro", hex: "#1A1A1A", images: ["assets/products/casacas/vintage17_negro.webp"], sizes: sizes(["M"]) }] },
  { id: "p24", cat: "Casacas", name: "Casaca Vintage Boston", price: 69.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Azul", hex: "#2455A4", images: ["assets/products/casacas/vintage_boston.webp"], sizes: sizes(["L"]) }] },
  { id: "p25", cat: "Casacas", name: "Casaca Impermeable", price: 79.00, old: null, badge: "low", desc: "Producto 100% peruano con forro acolchado interno.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/casacas/impermeable_verde.webp"], sizes: sizes(["M"]) }] },
  { id: "p26", cat: "Casacas", name: "Casaca New York", price: 69.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/casacas/casaca_ny.webp"], sizes: sizes(["M"]) }] },
  // ---- CHALECOS ----
  { id: "p27", cat: "Chalecos", name: "Chaleco impermeable", price: 59.00, old: null, badge: "low", desc: "Producto importado.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/chalecos/chaleco_impermeable_negro.webp"], sizes: sizes(["L"]) }, { name: "Azul", hex: "#2455A4", images: ["assets/products/chalecos/chaleco_impermeable_azul.webp"], sizes: sizes(["L"]) }] },
  // ---- ACCESORIOS ----
  { id: "p28", cat: "Accesorios", name: "Reloj Naviforce", price: 99.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/naviforce_normal.webp"], sizes: sizes(["Único"]) }] },
  { id: "p29", cat: "Accesorios", name: "Reloj Curren", price: 99.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/curren.webp"], sizes: sizes(["Único"]) }] },
  { id: "p30", cat: "Accesorios", name: "Reloj SKMEI", price: 89.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/skmei_normal.webp"], sizes: sizes(["Único"]) }] },
  { id: "p31", cat: "Accesorios", name: "Reloj Sanda Analógico", price: 99.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/sanda_verde.webp"], sizes: sizes(["Único"]) }] },
  { id: "p46", cat: "Accesorios", name: "Reloj Sanda Digital", price: 99.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/accesorios/sanda_digital.webp"], sizes: sizes(["Único"]) }] },
  { id: "p32", cat: "Accesorios", name: "Reloj Naviforce Digital", price: 89.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/naviforce_negro_digital.webp"], sizes: sizes(["Único"]) }] },
  { id: "p33", cat: "Accesorios", name: "Reloj Poedagar G", price: 89.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/poedagar_grueso.webp"], sizes: sizes(["Único"]) }] },
  { id: "p34", cat: "Accesorios", name: "Reloj Poedagar D", price: 89.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/poedagar_delgado.webp"], sizes: sizes(["Único"]) }] },
  { id: "p35", cat: "Accesorios", name: "Reloj SKMEI Digital", price: 89.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/skmei_digital.webp"], sizes: sizes(["Único"]) }] },
  { id: "p36", cat: "Accesorios", name: "Reloj Navifoce Verde", price: 89.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/accesorios/naviforce_verde_digital.webp"], sizes: sizes(["Único"]) }] },
  { id: "p37", cat: "Accesorios", name: "Reloj Naviforce Plus", price: 125.00, old: null, badge: "low", desc: "Producto importado, incluye caja.", colors: [{ name: "Estándar", hex: "#3A3A3A", images: ["assets/products/accesorios/naviforce_plus.webp"], sizes: sizes(["Único"]) }] },
  { id: "p38", cat: "Accesorios", name: "Reloj Poedagar Plateado", price: 115.00, old: null, badge: "low", desc: "Producto importado, incluye caja.", colors: [{ name: "Plateado", hex: "#B8B8B8", images: ["assets/products/accesorios/poedagar_plateado.webp"], sizes: sizes(["Único"]) }] },
  ...
  { id: "p40", cat: "Accesorios", name: "Gorra Conejo", price: 35.00, old: null, badge: null, desc: "Producto importado.", colors: [{ name: "Azul", hex: "#2455A4", images: ["assets/products/accesorios/gorro_conejo.webp"], sizes: sizes(["Único"]) }] },
  { id: "p41", cat: "Accesorios", name: "Lentes Plateado", price: 39.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Plateado", hex: "#B8B8B8", images: ["assets/products/accesorios/lentes_plateado.webp"], sizes: sizes(["Único"]) }] },
  { id: "p42", cat: "Accesorios", name: "Lentes Negro", price: 39.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/accesorios/lentes_negro.webp"], sizes: sizes(["Único"]) }] },
  { id: "p43", cat: "Accesorios", name: "Lentes Verde", price: 35.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Verde", hex: "#2F6B3A", images: ["assets/products/accesorios/lentes_verde.webp"], sizes: sizes(["Único"]) }] },
  { id: "p44", cat: "Accesorios", name: "Lentes Rojo", price: 25.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Rojo", hex: "#C0272D", images: ["assets/products/accesorios/lentes_rojo.webp"], sizes: sizes(["Único"]) }] },
  { id: "p45", cat: "Accesorios", name: "Lentes Negro Total", price: 35.00, old: null, badge: "low", desc: "Producto importado, incluye estuche.", colors: [{ name: "Negro", hex: "#1A1A1A", images: ["assets/products/accesorios/lentes_negro_total.webp"], sizes: sizes(["Único"]) }] },
];
