...
const products = [
  ...
  { id: "p11", cat: ["Polos", "Liquidacion"], name: "Polo Old Money", price: 19.90, old: 29.90, badge: "liquidacion", desc: "Producto peruano 100% algodón 20/01, peinado, reactivo y antipilling.", colors: [{ name: "Marrón", hex: "#5B3A29", images: ["assets/products/polos/oldmoney_marron.webp"], sizes: sizes(["M"]) }, { name: "Verde", hex: "#2F6B3A", images: ["assets/products/polos/oldmoney_verde.webp"], sizes: sizes(["L"]) }] },
